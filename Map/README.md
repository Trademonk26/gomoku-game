...
- 상태: **Phase 1-2 일부 진행 (2026-07-06)** — 시군구 230 단위 MVP + ILIS S축 공식 통계 적재
...
- **라이브 지표 10개** (모두 API 키 불필요 소스): P1·P2 변전소 근접성/밀도(OSM 154kV+ 847개), P6 대형 발전설비(OSM), W5 냉방도일(Open-Meteo ERA5 5개년), N1 육양국 거리(큐레이션), N2 서울 IX 지연 추정(산식), H3 지진구역계수(KDS), S1 미분양 산업시설용지·S6 분양공고 산업시설용지(ILIS 공식 통계), A1 유치 의지(출처 필수 큐레이션)
...
| (무키) ILIS 추가 정리 | industryland.or.kr | S2 조성중·계획 산업단지 공급 파이프라인 |
